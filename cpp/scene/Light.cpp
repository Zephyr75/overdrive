                              ...
                              const Scene& scene) const
{
    ...
    if (type == LightType::Sun) {
        glm::mat4 proj = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, nearPlane, farPlane);
        ...
        glm::mat4 shadowProj = glm::perspective(
            glm::radians(90.0f), Settings::shadowAspectRatio(), nearPlane, farPlane);
        ...
        for (int i = 0; i < 6; i++)
            depthCubeShader.setMat4("shadowMatrices[" + std::to_string(i) + "]", transforms[i]);
