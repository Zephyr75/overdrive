...
> Use gl.DYNAMIC_DRAW for vertex data that changes frequently
...
Texture: nearest or linear to interpolate

Mipmap: also store image/2, /4, /8... and choose appropriate size based on distance